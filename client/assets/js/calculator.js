...
function CalCommission() {
    ...
    //    //var returnL = "Rs. " + Math.round(calValueL / 1000) /100 + " K";
        returnL = "USD. " + (calDiffSL / 1000).toFixed(2) + " K";
        $("#returnAmount").text(returnL);
    }
    else{
        returnL = "USD. " + (calDiffSL / 100000).toFixed(2) + " L";
        $("#returnAmount").text(returnL);
    }
    console.log(returnL);
...
function changeValueToString(value) {
    ...
    if (value.toString().length == 4 || value.toString().length == 5) {
        var returnString = ('<i class="fa fa-dollar-sign"></i>' + (value / 1000).toFixed(2) + " K");
    } else if (value.toString().length == 6 || value.toString().length == 7) {
        var returnString = ('<i class="fa fa-dollar-sign"></i>' + (value / 100000).toFixed(2) + " L");
    } else if (value.toString().length == 8 || value.toString().length == 9) {
        var returnString = ('<i class="fa fa-dollar-sign"></i>' + (value / 10000000).toFixed(2) + " Cr");
    }
    return returnString;
}
